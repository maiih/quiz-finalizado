...
// Pega a pontuação ou inicia com valor zero
var key = 'pontuacao'
var pontuacao = localStorage.getItem(key) || 0

if (pontuacaoFinal != null) {
  let pontos = localStorage.getItem(key);
...
if (botaoContinuar !== null) {
  botaoContinuar.addEventListener('click', function (evento) {
    ...
    alternativas.forEach(a => {
      ...
      a.parentElement.style.borderRadius = '4px'
    });
    ...
    if (resposta == 'true') {
      ...
      localStorage.setItem(key, pontuacao);
    } else {
